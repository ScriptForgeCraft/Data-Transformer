...
const { determineColumnMappingAsync } = require("./layout");
const { postValidateFlat } = require("./validation");
...
// ═══════════════════════════════════════════════════════════════════════════════
async function processHeaderBlock(data, blockInfo, buildingName, sheetName, allFlats) {
...
// ═══════════════════════════════════════════════════════════════════════════════
async function processNoHeaderSheet(data, buildingName, sheetName, allFlats) {
    ...
    const headers = await determineColumnMappingAsync(new Array(colCount).fill(""), sampleRows);
